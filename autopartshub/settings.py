"""
Django settings for autopartshub project.
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "NamPhongAuto Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "NamePhongAuto",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "NamePhongAuto",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "./logo_100.png",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "./logo100.png",

    # Logo to use for login form in dark themes (defaults to login_logo)
    "login_logo_dark": "./logo100.png",
    ...
    "welcome_sign": "Welcome to Lightproweb Admin Page",

    # Copyright on the footer
    "copyright": "HK2 Team, 2024",
    ...
    "topmenu_links": [
        ...
        # {'name': 'Import data', 'url': 'finance-tracker', 'permissions': ['auth.change_user'], 'new_window': True},
    ...
    "usermenu_links": [
        # {'name': 'Home', 'url': 'index', 'new_window': True, 'icon': 'fas fa-home'},
        # {"name": "Import data", "url": "finance-tracker", "new_window": True, 'icon': 'fas fa-file-download'},
        # {"model": "auth.user",},
        # {"model": "staff.Employee", 'icon': 'fas fa-user-tie'},
        # {"model": "crm.Customer", 'icon': 'fas fa-user-tag'},
    ],
...
# custom sâu hơn về thứ tự hiển thị trên page 
# filter 
